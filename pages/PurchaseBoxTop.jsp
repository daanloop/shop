...
<table>
		...
		<c:forEach items="${purchase.choises}" var="choise">
			<tr>
				...
				<td align="center">￥<fmt:formatNumber value="${choise.pricewithtax}" pattern="###,###,###"/></td>
				<td align="center">1</td>
				<!-- <td></td> -->
				<td align="center">${choise.varietychoise}</td> 
		...
		<tr class="total">
				...
				<td align="center">￥<fmt:formatNumber value="${purchase.total}" pattern="###,###,###"/></td>
		</tr>
		</tbody>
	</table>
