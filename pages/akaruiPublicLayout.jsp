...
<link rel='canonical' href='http://africaandleo.com/' />
 <!-- Add 27 Nov -->
    <link href="<html:rewrite page="/contents.css"/>" rel="stylesheet" type="text/css" />
<!-- End -->
...
<li id="menu-item-586" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-586"><a href="#">Collection</a>
<ul class="sub-menu">
...
<li id="menu-item-323" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-323"><a href="http://africayleo.tumblr.com/">Blogs</a></li>
		...
		<div id="main">
				...
				オンラインによる「明るい部屋」ネットショップは
				システムリニューアルにつき、ご利用いただけません。
				お花のご注文は、直接下記へご連絡下さい。
				
				電話によるお問い合せ：03-3491-5030
				E-mailでのお問い合せ：<a href="mailto:info@akaruiheya.com">info@akaruiheya.com</a>
				</pre>
				<% }else{ %>
	...
	<div id="footer" role="contentinfo">
		<div id="colophon">
			...
			<div id="site-info">
				<!--<a href="http://africaandleo.com/" title="africaandleo" rel="home">
					africaandleo				</a> -->
			</div><!-- #site-info -->

			<div id="site-generator">
				<a href="http://africaandleo.com">AFRICAYLEO.AllRightReserved.</a>
			</div><!-- #site-generator -->
