...
<%--			<h1><img src="images/logo.gif" alt="MALTA" width="850" height="61" /></h1>--%>
			...
			<ul class="clearfix">
			<li><a href="/misc/index.html"><img src="/images/footer_01.gif" alt="会社概要" width="41" height="13" /></a></li>
			<li><a href="/misc/index.html#legal"><img src="/images/footer_02.gif" alt="特定商取引法に基づく表記" width="120" height="13" /></a></li>
			<li><a href="/misc/index.html#payment"><img src="/images/footer_03.gif" alt="お支払い方法" width="60" height="13" /></a></li>
			<li><a href="/misc/index.html#delivery"><img src="/images/footer_04.gif" alt="配送・送料について" width="83" height="13" /></a></li>
			<li><a href="/misc/index.html#privacy" target="_blank"><img src="/images/footer_05.gif" alt="プライバシーポリシー" width="91" height="13" /></a></li>
			</ul>
			<address><img src="/images/footer_copyright.gif" alt="Copyright &copy; moja-moja Inc. all rights reserved." width="250" height="13" /><img src="/images/footer_logo.gif" alt="moja-moja" width="85" height="13" />
			</address>
			</div><!-- footer end -->
