...
public final class ManageCarriage extends DispatchAction
{
    ...
    {
        final net.malta.model.crud.CarriageForm form = (net.malta.model.crud.CarriageForm)actionForm;

        net.malta.ManageableServiceLocator.instance().getCarriageManageableService().create(
            ...
            , (StringUtils.isBlank(request.getParameter("value"))) ? 0 : form.getValue()
    ...
    public ActionForward read(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        final java.util.List list = net.malta.ManageableServiceLocator.instance().getCarriageManageableService().read(
            (StringUtils.isBlank(request.getParameter("id"))) ? null : form.getId()
            , (StringUtils.isBlank(request.getParameter("name"))) ? null : form.getName()
            , (StringUtils.isBlank(request.getParameter("value"))) ? 0 : form.getValue()
            , (StringUtils.isBlank(request.getParameter("items"))) ? null : form.getItems()
        ...
        final java.util.Map backingLists = net.malta.ManageableServiceLocator.instance().getCarriageManageableService().readBackingLists();
    ...
    public ActionForward preload(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        final java.util.List list = net.malta.ManageableServiceLocator.instance().getCarriageManageableService().readAll();
        form.setManageableList(list);
    ...
    public ActionForward update(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        net.malta.ManageableServiceLocator.instance().getCarriageManageableService().update(
            (StringUtils.isBlank(request.getParameter("id"))) ? null : form.getId()
            , (StringUtils.isBlank(request.getParameter("name"))) ? null : form.getName()
            , (StringUtils.isBlank(request.getParameter("value"))) ? 0 : form.getValue()
            , (StringUtils.isBlank(request.getParameter("items"))) ? null : form.getItems()
    ...
    public ActionForward delete(ActionMapping mapping, ActionForm actionForm, HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        {
            net.malta.ManageableServiceLocator.instance().getCarriageManageableService().delete(selectedRows);
        }
